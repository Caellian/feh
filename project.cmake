...
set(MAINDIR ${CMAKE_INSTALL_PREFIX})
set(MANDIR ${CMAKE_INSTALL_PREFIX}/share/man)
set(BINDIR ${CMAKE_INSTALL_PREFIX}/bin)
set(DOCDIR ${CMAKE_INSTALL_PREFIX}/share/doc/feh)
set(IMAGEDIR ${CMAKE_INSTALL_PREFIX}/share/feh/images)
set(FONTDIR ${CMAKE_INSTALL_PREFIX}/share/feh/fonts)
set(DESKTOPDIR ${CMAKE_INSTALL_PREFIX}/share/applications)
set(EXAMPLEDIR ${CMAKE_INSTALL_PREFIX}/share/doc/feh/examples)
...
find_package(JSONC)
if (JSONC_FOUND AND OPTIONAL_JSONC)
    include_directories(${JSONC_INCLUDE_DIRS})
    set(MAN_JSONC enabled)
else ()
    set(MAN_JSONC disabled)
endif ()
